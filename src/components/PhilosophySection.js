...
const PhilosophySection = () => {
  return (
    <Chapter id="philosophy" className="bg-gradient-to-b from-charcoal-warm to-navy">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center text-left space-y-6">
          ...
          >
            ...
            <p className="font-sans text-base md:text-lg text-cream/80 leading-relaxed">
              I believe in <span className="text-violet font-semibold">optimal resource allocation</span>—
            ...
            <p className="font-sans text-base md:text-lg text-cream/80 leading-relaxed">
              <span className="text-rose font-semibold">Emotion and logic</span> aren't opposites—
            ...
            <p className="font-sans text-base md:text-lg text-cream/80 leading-relaxed">
              I see <span className="text-teal font-semibold">technology as art</span>—
              where craft meets purpose, where architecture meets experience,
              where every detail matters because <span className="text-champagne italic">恰到好处</span>:
