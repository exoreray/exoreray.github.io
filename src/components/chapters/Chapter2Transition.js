...
const Chapter2Transition = () => {
  return (
    <Chapter id="transition" className="bg-gradient-to-b from-charcoal-warm to-navy">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center text-left space-y-6">
          ...
          >
            <p className="font-sans text-lg md:text-xl text-cream/90 leading-relaxed">
              I studied <span className="text-teal font-semibold">architecture</span> — learning to shape spaces,
            ...
            <p className="font-sans text-base md:text-lg text-cream/80 leading-relaxed">
              But then I discovered something profound: <span className="text-violet italic">digital architecture</span>.
            ...
            <p className="font-sans text-base md:text-lg text-cream/80 leading-relaxed">
              ...
              Spaces without physical constraints. <span className="text-champagne font-semibold">Architecture at the speed of thought</span>.
            </p>
